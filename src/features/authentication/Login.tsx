    ...
    if (signed) {
        ...
        return (
            <PageGrid container >
                ...
                <FormContainer>
                    <Box sx={{ width: 320 }} component="form" noValidate autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <FormButtonsContainer>
                            <LoginButton type="submit" variant="contained" size="large">Login</LoginButton>
                            <Button type="button" variant="text">Esqueceu sua senha?</Button>
                        </FormButtonsContainer>

                        <Fade in={isError}>
                            <Typography color="secondary" sx={{ textAlign: 'center', mt: 2 }}>
                    ...
                    <Copyright color="primary">
                        © 2019-{new Date().getFullYear()} <a style={{ textDecoration: 'none', color: 'inherit' }} href="https://flatlogic.com" rel="noopener noreferrer" target="_blank">Mindcloud</a> - Todos os direitos reservados.
                    </Copyright>
