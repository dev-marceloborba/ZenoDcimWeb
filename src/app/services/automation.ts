...
export const automationApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        addModbusTag: builder.mutation<ApiResponse<ModbusTagResponse>, ModbusTagRequest>({
            query: (newModbusTag) => ({
                url: "v1/modbusTags",
                method: 'POST',
                body: newModbusTag
...
export const { useListPlcsQuery, useListModbusTagsQuery, useAddModbusTagMutation, useAddPlcMutation } = automationApi