...
export const companyApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        createCompany: builder.mutation<ApiResponse<CompanyResponse>, CompanyRequest>({
            query: (company) => ({
                url: 'v1/companies',
                method: 'POST',
                body: company
        ...
        createContract: builder.mutation<ApiResponse<ContractResponse>, ContractRequest>({
            query: (contract) => ({
                url: 'v1/contracts',
                method: 'POST',
                body: contract
...
export const { useListCompaniesQuery, useListContractsQuery, useCreateCompanyMutation, useCreateContractMutation } = companyApi